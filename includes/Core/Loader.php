 ...
 * public-facing hooks.
 *
 * Also maintains the list of all hooks that were registered with a hook
 * manager.
 *
 * @since      1.0.0
 * @package    AlfawzQuran
...
class Loader {
     ...
     * @since    1.0.0
     * @access   private
     * @param    array                $hooks            The collection of callbacks that is being registered (either actions or filters).
     * @param    string               $hook             The name of the WordPress hook that is being registered.
    ...
    /**
     * Register the filters and actions with the WordPress Hook API.
     *
     * @since    1.0.0
     */
    public function run() {
