        ...
        if ( isset( $_GET['page'] ) && strpos( sanitize_key( wp_unslash( $_GET['page'] ) ), 'alfawz-quran' ) !== false ) {
            ...
            wp_localize_script('alfawz-admin-script', 'alfawzAdminData', [
                ...
                'strings'          => [
                    ...
                    'userCreated'        => __( 'User created successfully.', 'alfawzquran' ),
                    'userCreatedNoEmail' => __( 'User created successfully. Share this temporary password: %s', 'alfawzquran' ),
                    'userCreationError'  => __( 'Unable to create user.', 'alfawzquran' ),
                    'userValidationError'=> __( 'Please provide a name, valid email address, and role for the new user.', 'alfawzquran' ),
                    'userEmailNotice'    => __( 'A welcome email has been sent with login instructions.', 'alfawzquran' ),
                    'userEmailNotSent'   => __( 'Email notification was not sent. Share the credentials with the user directly.', 'alfawzquran' ),
                    'saving'             => __( 'Saving…', 'alfawzquran' ),
                ],
            ]);
        }
    }
