    ...
    public function enqueue_assets() {
        if ($this->is_alfawz_page()) {
            ...
            wp_localize_script('alfawz-frontend', 'alfawzData', [
                ...
                'pages' => [
                    'dashboard'   => trailingslashit(home_url('/alfawz-dashboard/')),
                    'reader'      => trailingslashit(home_url('/alfawz-reader/')),
                    'memorizer'   => trailingslashit(home_url('/alfawz-memorizer/')),
                    'leaderboard' => trailingslashit(home_url('/alfawz-leaderboard/')),
                    'profile'     => trailingslashit(home_url('/alfawz-profile/')),
                    'settings'    => trailingslashit(home_url('/alfawz-settings/')),
                ],
