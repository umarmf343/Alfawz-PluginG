        ...
        if ($this->is_alfawz_page()) {
            ...
            wp_localize_script('alfawz-frontend', 'alfawzData', [
                ...
                'strings' => [
                    ...
                    'gamePanelGrowthTitle' => __('Nurture the Tree of Noor!', 'alfawzquran'),
                    'gamePanelGrowthInProgress' => __('Recite verses to help your tree flourish.', 'alfawzquran'),
                    'gamePanelGrowthComplete' => __('Takbir! Your tree blossomed into a new canopy—keep nourishing it!', 'alfawzquran'),
                    'gamePanelGrowthStageLabel' => __('Growth Stage', 'alfawzquran'),
                    ...
                    'eggCelebrationMessage' => __('Takbir! You cracked the egg challenge.', 'alfawzquran'),
