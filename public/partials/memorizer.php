            ...
            <article class="mx-auto flex w-full max-w-4xl flex-col gap-8 rounded-3xl bg-white p-8 text-slate-800 shadow-2xl ring-1 ring-slate-200/70">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    ...
                    <div class="group relative overflow-hidden rounded-3xl bg-[radial-gradient(circle_at_top_right,_#22c55e,_#06b6d4,_#6366f1)] p-6 text-center text-white shadow-2xl">
                        ...
                        <button type="button" id="repeat-btn" class="group relative mt-6 inline-flex w-full items-center justify-center gap-3 overflow-hidden rounded-3xl bg-gradient-to-br from-[#800000] via-[#9b1c31] to-[#fff8e1] px-7 py-4 text-3xl font-semibold text-white shadow-xl transition-all duration-300 ease-out hover:scale-[1.05] hover:from-[#990000] hover:via-[#b83a45] hover:to-[#fff0c2] focus:outline-none focus:ring-4 focus:ring-white/40 focus:ring-offset-2 focus:ring-offset-transparent disabled:cursor-not-allowed disabled:opacity-70">
