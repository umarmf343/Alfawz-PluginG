    ...
    <div class="relative mx-auto max-w-6xl space-y-16 px-4 py-14 sm:px-6 lg:px-8">
        <section aria-labelledby="alfawz-memorization-start-title" class="space-y-8 text-center">
            ...
            <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-2">
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#800000] via-[#fff1e6] to-[#fff1e6] p-6 text-left shadow-2xl ring-1 ring-[#800000]/50">
        ...
        <section id="alfawz-memorization-active" class="hidden space-y-12">
            ...
            <div class="relative mx-auto w-full max-w-4xl overflow-hidden rounded-3xl bg-gradient-to-br from-sky-500 via-indigo-500 to-rose-500 p-8 shadow-2xl ring-1 ring-white/25">
                <div class="absolute inset-0 bg-gradient-to-br from-[#800000]/80 via-[#fff1e6]/40 to-[#800000]/70 backdrop-blur-sm"></div>
            ...
            <section id="alfawz-recitation-assistant" class="relative mx-auto w-full max-w-4xl overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-sky-500 p-8 text-white shadow-2xl ring-1 ring-indigo-200/60 is-listening">
                    ...
                    <div class="flex-1 space-y-6">
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <button type="button" id="alfawz-recitation-blur-toggle" class="inline-flex items-center gap-2 rounded-2xl border border-white/50 px-4 py-2 text-sm font-semibold text-white/90 transition hover:-translate-y-0.5 hover:border-white hover:text-white focus:outline-none focus:ring-2 focus:ring-white/40" aria-pressed="false">
                                <span aria-hidden="true"><img draggable="false" role="img" class="emoji" alt="🙈" src="https://s.w.org/images/core/emoji/16.0.1/svg/1f648.svg" /></span>
                                <span data-label><?php esc_html_e( 'Blur verse', 'alfawzquran' ); ?></span>
                            </button>
                        </div>
                        ...
                        <div class="rounded-3xl border border-white/20 bg-gradient-to-br from-white/30 via-rose-200/20 to-indigo-200/20 p-6 text-center shadow-xl backdrop-blur">
                            ...
                            <p id="alfawz-recitation-verse" class="mt-1 text-4xl leading-snug text-white/90"><?php esc_html_e( 'Surah 106 • Ayah 1', 'alfawzquran' ); ?></p>
                            <p id="alfawz-recitation-transliteration" class="mt-2 text-2xl text-white/80">
                                <?php esc_html_e( 'Li-eelafi Quraysh.', 'alfawzquran' ); ?>
                            </p>
                            <p id="alfawz-recitation-translation" class="mt-2 text-3xl italic text-white/80"><?php esc_html_e( 'For the accustomed security of the Quraysh -', 'alfawzquran' ); ?></p>
                ...
                <div id="alfawz-recitation-history" class="mt-6 hidden rounded-3xl border border-white/25 bg-white/10 p-5 shadow-xl backdrop-blur">
                    <div class="flex items-center justify-between">
                        <h4 class="text-xs font-semibold uppercase tracking-[0.3em] text-white/80"><?php esc_html_e( 'Recent sessions', 'alfawzquran' ); ?></h4>
                        <button type="button" id="alfawz-recitation-history-close" class="text-xs font-semibold uppercase tracking-[0.3em] text-white/70 hover:text-white focus:outline-none"><?php esc_html_e( 'Close', 'alfawzquran' ); ?></button>
                    </div>
                    <ul id="alfawz-recitation-history-list" class="mt-4 space-y-3 text-sm text-white/80">
                        <li class="text-white/70"><?php esc_html_e( 'You have not recorded any recitation feedback yet.', 'alfawzquran' ); ?></li>
                    </ul>
                </div>
            </section>

            <section id="alfawz-memorization-surah-contents" class="hidden">
                <div class="mx-auto flex w-full max-w-4xl flex-col gap-6 rounded-3xl bg-gradient-to-br from-sky-500 via-indigo-600 to-purple-600 p-8 text-white shadow-2xl ring-1 ring-indigo-200/60">
                    <header class="text-center">
                        <p class="text-sm font-semibold uppercase tracking-[0.3em] text-white/80"><?php esc_html_e( 'Surah overview', 'alfawzquran' ); ?></p>
                        <p class="mt-2 text-lg text-white/80"><?php esc_html_e( 'All verses from the selected surah are displayed below for immersive review.', 'alfawzquran' ); ?></p>
                    </header>
                    <div id="alfawz-memorization-verse-list" class="space-y-4"></div>
                </div>
            </section>

            <section id="alfawz-memorization-stats" class="grid grid-cols-2 gap-6 text-center text-white sm:grid-cols-2 md:grid-cols-4">
                <div class="flex min-h-[220px] flex-col items-center justify-center rounded-3xl bg-gradient-to-br from-sky-500 via-cyan-400 to-blue-600 p-10 shadow-2xl ring-1 ring-sky-200/60">
                    <p class="text-6xl uppercase tracking-[0.3em] text-white/90"><?php esc_html_e( 'Total verses', 'alfawzquran' ); ?></p>
                    <p id="alfawz-memorization-stat-total" class="mt-4 text-[7.5rem] font-extrabold">0</p>
                </div>
                <div class="flex min-h-[220px] flex-col items-center justify-center rounded-3xl bg-gradient-to-br from-emerald-500 via-green-400 to-teal-600 p-10 shadow-2xl ring-1 ring-emerald-200/60">
                    <p class="text-6xl uppercase tracking-[0.3em] text-white/90"><?php esc_html_e( 'Memorised', 'alfawzquran' ); ?></p>
                    <p id="alfawz-memorization-stat-memorized" class="mt-4 text-[7.5rem] font-extrabold">0</p>
                </div>
                <div class="flex min-h-[220px] flex-col items-center justify-center rounded-3xl bg-gradient-to-br from-rose-500 via-fuchsia-400 to-amber-500 p-10 shadow-2xl ring-1 ring-rose-200/60">
                    <p class="text-6xl uppercase tracking-[0.3em] text-white/90"><?php esc_html_e( 'Remaining', 'alfawzquran' ); ?></p>
                    <p id="alfawz-memorization-stat-remaining" class="mt-4 text-[7.5rem] font-extrabold">0</p>
                </div>
                <div class="flex min-h-[220px] flex-col items-center justify-center rounded-3xl bg-gradient-to-br from-purple-500 via-violet-400 to-indigo-600 p-10 shadow-2xl ring-1 ring-purple-200/60">
                    <p class="text-6xl uppercase tracking-[0.3em] text-white/90"><?php esc_html_e( 'Completion', 'alfawzquran' ); ?></p>
                    <p id="alfawz-memorization-stat-completion" class="mt-4 text-[7.5rem] font-extrabold">0%</p>
                </div>
            </section>
        </section>
    </div>
