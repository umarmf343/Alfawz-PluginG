<div class="alfawz-reader">
    <div class="alfawz-page-stack">
        ...
        <div class="alfawz-primary-actions">
            ...
            <button id="reader-mark-read" class="alfawz-beautiful-btn">
                <span class="alfawz-btn-icon-wrapper"><span class="alfawz-btn-icon">✅</span></span>
                <span class="alfawz-btn-text"><?php _e('Mark as Read', 'alfawzquran'); ?></span>
                <span class="alfawz-btn-glow"></span>
            </button>
            <button id="reader-bookmark" class="alfawz-beautiful-btn">
                <span class="alfawz-btn-icon-wrapper"><span class="alfawz-btn-icon">🔖</span></span>
        ...
        <div class="alfawz-mobile-controls-row">
            <button id="prev-verse-btn" class="alfawz-mobile-nav-btn" disabled>
...
<div class="alfawz-bottom-navigation">
    <div class="alfawz-nav-container">
        ...
        <a href="<?php echo esc_url(ALFAWZQURAN_PLUGIN_URL . 'reader/'); ?>" class="alfawz-nav-item active">
            <span class="alfawz-nav-icon">📖</span>
